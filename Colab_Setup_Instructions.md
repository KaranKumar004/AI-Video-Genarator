...
This script mounts Google Drive (to keep model checkpoints and configurations persistent so you don't have to re-download 16 GB of files every time!), downloads the SDXL RealVisXL V4 checkpoint and AnimateDiff motion modules, configures custom nodes, starts ComfyUI, and launches a secure Cloudflare tunnel.
...
!python main.py --dont-upcast-attention --listen 127.0.0.1 --port 8188
```
